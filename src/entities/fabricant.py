...
def Fabricant(MOD_fabricant_Q, log):
    ...
    while True:
        ...
        # Offre toujours en négociation
            ...
            log.put(f"Fabricant {id} : envoie une contre offre")
            MOD_fabricant_Q.put({
